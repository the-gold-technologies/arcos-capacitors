      ...
      <div className="lg:col-span-7 space-y-6">
        <div className="glassmorphism rounded-3xl p-8 border border-white/5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
            <div>
              <h4 className="text-zinc-900 text-sm font-semibold">Self-locking Head</h4>
              <p className="text-zinc-550 text-xs mt-1">
                Four-tooth pawl latch guarantees a slip-proof lock under tensile pressure.
              </p>
            </div>
            <div>
              <h4 className="text-zinc-900 text-sm font-semibold">UV Resistance</h4>
              <p className="text-zinc-550 text-xs mt-1">
                Carbon-black added polymers protect against solar decay in outdoor projects.
              </p>
            </div>
            <div>
              <h4 className="text-zinc-900 text-sm font-semibold">Thermal Tolerance</h4>
              <p className="text-zinc-550 text-xs mt-1">
