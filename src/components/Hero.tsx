        ...
        <div className="lg:col-span-5 flex justify-center relative">
          ...
          >
            ...
            <svg viewBox="0 0 400 400" className="absolute inset-0 w-full h-full z-10 opacity-70">
              <circle cx="200" cy="200" r="160" stroke="rgba(255,255,255,0.05)" strokeWidth="1" strokeDasharray="4 8" />
              <circle cx="200" cy="200" r="120" stroke="rgba(210,35,42,0.15)" strokeWidth="1.5" />
              
              {/* Tech HUD crosshairs */}
              <path d="M 200 10 L 200 45 M 200 355 L 200 390 M 10 200 L 45 200 M 355 200 L 390 200" stroke="rgba(210,35,42,0.4)" strokeWidth="2" />
            ...
            >
              <svg viewBox="0 0 200 300" className="w-[180px] h-[270px] drop-shadow-[0_15px_30px_rgba(0,0,0,0.6)]">
                <defs>
