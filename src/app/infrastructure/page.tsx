...
import { Building, Settings, Gauge, Check, Zap } from "lucide-react";
...
const infrastructureHighlights = [
  {
    ...
    suffix: " Sq. Ft.",
    icon: Building,
    desc: "Modern Noida industrial park zone layout",
  },
  {
    label: "Daily Production Outflow",
    val: "25,000",
    suffix: " Units",
    icon: Settings,
    desc: "Equipped for large bulk OEM demands",
  },
  {
    label: "Continuous Power Backup",
    val: "100",
    suffix: "%",
    icon: Zap,
    desc: "High-capacity DG generator support",
  },
  {
    label: "Compressor Utility",
    val: "Kaeser",
    suffix: " German",
    icon: Gauge,
    desc: "High-stability pneumatic line supply",
  },
];
...
export default function Infrastructure() {
  return (
    <div className="relative w-full">
      ...
      <div className="absolute top-[25%] -left-[10%] h-[400px] w-[400px] rounded-full bg-primary/6 filter blur-[120px] pointer-events-none -z-10" />
      <div className="absolute bottom-[20%] -right-[10%] h-[450px] w-[450px] rounded-full bg-primary/5 filter blur-[130px] pointer-events-none -z-10" />
        ...
        <section className="mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 text-left space-y-4">
              ...
              <p className="text-zinc-650 text-sm sm:text-base leading-relaxed max-w-xl">
                Operating from a state-of-the-art facility in Noida, Uttar
                Pradesh, ARCOS combines advanced automated winding systems with
                rigorous clean-room testing workflows to produce up to 25,000
                premium components daily.
              </p>
            </div>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {infrastructureHighlights.map((hl, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white border border-zinc-200 rounded-2xl p-6 flex flex-col items-start gap-4 shadow-sm"
              >
                ...
                <div>
                  <span className="text-zinc-550 text-xs font-semibold uppercase tracking-wider block">
                    {hl.label}
                  </span>
                  <div className="flex items-baseline gap-0.5 mt-1">
                    <span className="text-2xl font-extrabold text-zinc-950 tracking-tight font-mono">
                      {hl.val}
                    </span>
                  ...
                  <span className="text-zinc-600 text-xs mt-2 block leading-relaxed">
                    {hl.desc}
                  </span>
                </div>
              </div>
      ...
      {/* 3. Interactive Assembly Line Visualizer (Full-bleed Section) */}
      <WorkflowVisualizer />
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={idx}
                className="bg-white border border-zinc-200 rounded-2xl p-5 flex items-center gap-4 hover:border-zinc-300 transition-colors shadow-sm"
              >
                <span className="text-zinc-455 font-mono text-sm shrink-0 font-bold">
        ...
        <section className="relative rounded-[30px] overflow-hidden bg-white border border-zinc-200 p-8 sm:p-12 shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-4 bg-zinc-50 border border-zinc-200 p-6 rounded-2xl space-y-4 shadow-inner">
              <h4 className="text-zinc-900 text-sm font-bold uppercase tracking-wider">
                Quality Benchmarks
              </h4>
